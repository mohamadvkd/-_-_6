...
class _ReaderPageState extends State<ReaderPage> {
  ...
  Future<void> _togglePlayPause() async {
    ...
    // إذا السورة المفتوحة مختلفة عن المشغّل الحالي
  ...
  void _openFullPlayer() {
    // نفتح فقط إذا كان هناك صوت محمّل
  ...
  // ============================================================
  // المشغل المصغّر — ينقر → يفتح PlayerPage
  // ============================================================
